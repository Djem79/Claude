        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {combos.map(c => (
            <Link
              ...
              className="group bg-white rounded-sm border border-gray-100 shadow-sm hover:shadow-md hover:border-gold/40 transition-all p-5 flex flex-col"
            >
              <span className="block w-8 h-px bg-gold mb-3 transition-all group-hover:w-12" />
