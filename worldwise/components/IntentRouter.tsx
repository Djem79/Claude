...
export default function IntentRouter() {
  ...
  const card = 'flex flex-col items-center text-center gap-2 bg-white rounded-sm border border-gray-200 px-4 py-7 hover:border-gold hover:shadow-md transition-all'
  const line = <span className="block w-8 h-px bg-gold mb-1" />
  return (
