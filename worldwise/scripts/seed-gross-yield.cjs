...
const AREAS = [
  ...
  { name: 'Palm Jumeirah',    y: 4.5, t: ['Palm Jumeirah'] },
  { name: 'Business Bay',     y: 6.5, t: ['Business Bay'] },
  { name: 'Dubai Hills',      y: 6.0, t: ['Dubai Hills'] },
  { name: 'JLT',              y: 6.5, t: ['JLT', 'Jumeirah Lake Towers', 'Jumeirah Lakes Towers'] },
  { name: 'Creek Harbour',    y: 6.0, t: ['Creek Harbour', 'Dubai Creek Harbour'] },
  { name: 'Emaar Beachfront', y: 4.75, t: ['Emaar Beachfront'] },
  // expansion (per-property only; no landing pages) — SPECIFIC BEFORE GENERAL
  { name: 'Damac Hills 2',    y: 6.0, t: ['Damac Hills 2'] },
  { name: 'Damac Hills',      y: 5.5, t: ['Damac Hills'] },
  { name: 'MBR City/Sobha Hartland/Meydan', y: 6.25, t: ['Sobha Hartland', 'MBR City', 'Mohammed Bin Rashid', 'Meydan'] },
  { name: 'Dubailand/Arjan/Majan', y: 7.5, t: ['Dubailand', 'Arjan', 'Majan'] },
  { name: 'The Valley',       y: 5.0, t: ['The Valley'] },
  { name: 'Expo City',        y: 7.0, t: ['Expo'] },
  { name: 'Dubai Investment Park', y: 8.0, t: ['Investment Park'] },
  { name: 'Dubai Harbour',    y: 5.5, t: ['Dubai Harbour'] },
  { name: 'Dubai South',      y: 7.0, t: ['Dubai South'] },
  { name: 'Al Furjan',        y: 7.5, t: ['Al Furjan'] },
  { name: 'Maritime City',    y: 6.5, t: ['Maritime City'] },
  { name: 'Dubai Sports City', y: 8.0, t: ['Sports City', 'Sport City'] },
