...
export const metadata: Metadata = {
  title: 'UAE Mortgage Calculator 2025 | Dubai Property Financing',
  description:
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'In 2025, mortgage rates for non-residents range from approximately 3.5% to 5.5% per annum, depending on the bank, term, and your financial profile. Rates can be fixed (for 1–5 years) or variable (linked to EIBOR). A mortgage broker can compare rates across 15+ banks simultaneously.',
  },
  {
