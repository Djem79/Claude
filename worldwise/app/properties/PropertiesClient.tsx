  ...
  function FilterSelect({
    ...
    return (
      <select
        ...
        className="border border-gray-200 bg-white px-4 py-2.5 rounded-sm text-navy text-sm focus:outline-none focus:border-gold"
      >
        {options.map(o => (
    ...
    <>
      ...
      {filtered.length === 0 ? (
        <div className="text-center py-16 text-gray-400">
          ...
          <button onClick={() => { setArea('All Areas'); setStatus('all'); setType('all'); setMaxPrice(25_000_000) }} className="text-gold underline">
            Reset filters
          </button>
        </div>
      ) : (
