...
`hero_cta`, `mortgage_calculator`, `roi_calculator`, `property_enquiry`, `lead_capture_section`, `floating_cta`, `blog_cta`, `golden_visa`, `lead_magnet_guide`, `property_card`, `mobile_bar`, `qualify`, `telegram`, `property_finder`, `bayut`, `instagram_dm`, `whatsapp`, `other`, `area_dubai_marina`, `area_downtown_dubai`, `area_palm_jumeirah`, `area_business_bay`, `area_dubai_hills`, `area_jlt`, `area_creek_harbour`, `area_emaar_beachfront`
